...
async def init_db():
    ...
    async with _pool.acquire() as conn:
        ...
        await conn.execute("""
            ...
            ALTER TABLE track_audio_analysis ADD COLUMN IF NOT EXISTS first_audio_start_seconds DOUBLE PRECISION;
            ALTER TABLE track_audio_analysis ADD COLUMN IF NOT EXISTS last_audio_end_seconds DOUBLE PRECISION;
            ALTER TABLE track_audio_analysis ADD COLUMN IF NOT EXISTS leading_silence_seconds DOUBLE PRECISION;
            ALTER TABLE track_audio_analysis ADD COLUMN IF NOT EXISTS trailing_silence_seconds DOUBLE PRECISION;
        """)
