...
def configure_logging():
    ...
    max_bytes = log_config.get("rotation", {}).get("max_bytes", 10 * 1024 * 1024) # 10MB
    ...
    backend_handler.addFilter(ExcludeFilter(["scanner", "app.upnp", "async_upnp_client", "app.api.player", "uvicorn.access"]))
