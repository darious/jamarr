...
Full documentation lives in [`docs/`](docs/) and is published as a site
(MkDocs Material → GitHub Pages). Highlights:

| Topic | Source |
|:---|:---|
| Install & configuration | [docs/getting-started/](docs/getting-started/) |
| Architecture & decisions (ADRs) | [docs/architecture/](docs/architecture/) |
| API reference (generated from OpenAPI) | [docs/reference/api.md](docs/reference/api.md) |
| Database schema (generated by tbls) | [docs/reference/schema/](docs/reference/schema/) |
| Scanner CLI, env vars | [docs/reference/](docs/reference/) |
| Clients (web, TUI, Android) | [docs/clients/](docs/clients/) |
