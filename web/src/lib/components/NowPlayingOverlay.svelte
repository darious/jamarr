...
{#if $nowPlayingVisible}
  <div class="fixed inset-0 z-[60] overflow-hidden bg-black text-white/90">
    ...
    <div
      class="relative z-10 max-w-7xl mx-auto px-8 pt-20 pb-24 h-full flex flex-col gap-6"
    >
      ...
      <div
        class="flex flex-col lg:flex-row gap-8 items-stretch flex-1 min-h-0 pb-4"
      >
        <!-- Left: Square Art -->
        <div
          class="relative h-full w-auto aspect-square rounded-3xl overflow-hidden shadow-2xl bg-surface-900/50 border border-white/5 order-2 lg:order-1"
        >
          <img
        ...
        <div
          class="flex-1 flex flex-col h-full gap-6 order-1 lg:order-2 min-w-0"
        >
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div class="min-w-0 flex-1">
                        ...
                        <div class="flex items-center gap-2">
                          <div
                            class="text-xs text-white/60 truncate max-w-[60%]"
                          >
